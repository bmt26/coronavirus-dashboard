      ...
      <div class="text">
        ...
        <div class="para">
          ...
          <p class="land">
            ...
            desired as well as compare countries by their statistics.
          </p>
          <p class="land">This web app was built using the Google and Covid-19 API's.</p>
          <p class="land">
            This web app was built by the combined efforts of Brian Temple, Jhon Garcia, John
            Houlihan, and Shail Parekh.
          </p>
        </div>
      </div>
    </div>
